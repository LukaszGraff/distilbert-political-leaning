...
def main():
    ...
    explain_texts(random_posts, lime_analyzer, output_dir, names)
    ...
    for pred in ['left_score', 'center_score', 'right_score']:
        ...
        explain_texts(top_correct_posts, lime_analyzer, output_dir, names)
    ...
    for pred in ['left_score', 'center_score', 'right_score']:
        ...
        explain_texts(top_incorrect_posts, lime_analyzer, output_dir, names)
